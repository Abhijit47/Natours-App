...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiYWswMDciLCJhIjoiY2xkOW9scW9kMGIxbzNxbGlzbm8yeHpqcSJ9.2jSMTffIVBgdMLST7ulmlQ';
      ...
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: 'POST',
            url: 'http://localhost:9999/api/v1/users/login',
            data: {
              email: email,
              password: password
            }
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: 'GET',
            url: 'http://localhost:9999/api/v1/users/logout'
          });
  ...
  _regeneratorRuntime().mark(function _callee(data, type) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          url = type === 'password' ? 'http://localhost:9999/api/v1/users/updateMyPassword' : 'http://localhost:9999/api/v1/users/updateMe';
          _context.next = 4;
          return (0, _axios.default)({
            method: 'PATCH',
            url: url,
        ...
        case 4:
          ...
          if (res.data.status === 'success') {
            (0, _alert.showAlert)('success', "".concat(type.toUpperCase(), " updated successfully")); // window.setTimeout(() => {
            //   location.assign('/me');
            // }, 1500);
          }
...
var stripe = Stripe('pk_test_51MVQziSGJh9U4XqEFl1X2EhS1kajS1qQOzYCVKmdhhqM15gwZxSRNkbfvS7hIwxlvETtlHf5iJt7dQzNPDASxCgr009jhDZrTc');
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return (0, _axios.default)("http://localhost:9999/api/v1/bookings/checkout-session/".concat(tourId));
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "25405" + '/');
